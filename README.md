...
| Causal ATE (COVID-adjusted) | ✅ ATE=+0.0027, p=0.031 * | COVID window capped Nov 2019; PSM + Mahalanobis + AIPW + permutation all agree |
...
**Results:** After COVID correction (outcome window capped Oct 2019): ATE = +0.0027 (p=0.031, statistically significant). All 3 confounders well-balanced post-matching (SMD < 0.1). Validated by PSM, Mahalanobis, doubly-robust AIPW, and permutation test. E-value=2.03.
